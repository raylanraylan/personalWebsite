...
<template>
  <section class="relative bg-cork">
    ...
    <Card class="block w-[300px] sm:w-[450px] bg-paper rounded-lg mb-10 shadow-xl shadow-amber-800/50 last:mb-0"
      :class="Number(index) % 2 === 0 ? 'mr-auto -rotate-2' : 'ml-auto rotate-2'"
